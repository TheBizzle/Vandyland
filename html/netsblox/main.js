      ...
      (response) => {
        response.text().then(
          (responseText) => {
            ...
            } else if (responseText !== "netsblox") {
              alert(`This gallery (${sessionName}) was made for the '${responseText}' activity, but this is the 'netsblox' activity.  This gallery may not work correctly unless opened in the appropriate activity.`);
            }
          }
        )
      }
