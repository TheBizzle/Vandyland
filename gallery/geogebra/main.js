      ...
      (response) => {
        response.text().then(
          (responseText) => {
            ...
            } else if (responseText !== "geogebra") {
              alert(`This gallery (${sessionName}) was made for the '${responseText}' activity, but this is the 'geogebra' activity.  This gallery may not work correctly unless opened in the appropriate activity.`);
            }
          }
        )
      }
